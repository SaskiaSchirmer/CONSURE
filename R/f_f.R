#' density function for recovered individuals
#'
#' This function sets up the density function for every spatiotemporal point for recovered individuals
...
#' @export
#' @examples f_f()
f_f <- function(w,t,b,s,m,r,T){
  f(b,w)*(s(w)^(t-1)*(1-s(w))*r)
}
