---
title: "1SimulatingDataWithCONSURE"
...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 4
vignette: >
  %\VignetteIndexEntry{1SimulatingDataWithCONSURE}
...
# Simulating data with CONSURE

If you do not want to simulate data, but estimate parameters for your data, you can skip this vignette and rather read the vignette on [how to estimate parameters](EstimatingParameters.html) or [how to work with real-world data](workingWithRealWorldData.html). Nevertheless, this vignette may help you to understand the background of how this package works.
