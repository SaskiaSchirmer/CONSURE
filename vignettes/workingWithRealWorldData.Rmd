...
```{r fig.fullwidth = TRUE, fig.width=7, fig.height=4, eval = FALSE}
...
```{r fig.fullwidth = TRUE, fig.width=4, fig.height=7, eval = FALSE}
...
```{r fig.fullwidth = TRUE, fig.height=7, fig.width=7, eval = FALSE}
...
Therefore, we estimate the parameters for the example data set of robins:
```{r eval = FALSE}
data(robinsInit)
robinsInit$recoveryData <- renameData(recoveryData = robinsInit$recoveryData, 
                                      xname = "recLon", 
